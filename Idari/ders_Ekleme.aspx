<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ders_Ekleme.aspx.cs" Inherits="Idari_ders_Ekleme" %>
...
<span id="lblStatisticBuf"><div class="row">       
    ...
    <label for="exampleInputName2">ders kodu</label>
    <asp:TextBox runat="server" ID="id" CssClass="form-control" ></asp:TextBox>
  </div>
 
     <label for="exampleInputName2">ders kodu</label>
   <asp:TextBox runat="server" ID="dersadi" CssClass="form-control" ></asp:TextBox>
  </div>
     
             <asp:Button Text="Kaydet" ID="kaydetders" runat="server" CssClass="btn btn-success" OnClick="kaydetders_Click" />
  ...
  <thead>
      ...
      <tr>
          ...
          <th>ders işlemleri</th>
                 ...
                 <tbody>
                     <asp:Repeater ID="derslistrep" runat="server">
                         <ItemTemplate>
                              <tr>
                         <td><%# Eval ("dersid")%></td>
                                  <td><%# Eval ("dersadı")  %></td>
                                  <td>
                                      <asp:HyperLink NavigateUrl='<%# String.Format("ders_Silme.aspx?id={0}",Eval("dersid")) %>' runat="server" Class="btn btn-danger">sil</asp:HyperLink>
                                      <asp:HyperLink NavigateUrl='<%# String.Format("dersgüncelle.aspx?id={0}",Eval("dersid")) %>' runat="server" Class="btn btn-success">güncelle</asp:HyperLink>
