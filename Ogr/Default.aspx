<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="Ogr_Default" %>
...
<head runat="server">
    ...
    <title>Öğrenci Bilgi Sistemi : Öğrenci</title>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0">Öğrenci Paneli</h1>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-12">
                                <div class="info-box">
                                    ...
                                    <iframe src="duyuru.aspx" id="IFRAME1" name="IFRAME1" style="width: 100%; padding: 2px; visibility: visible; height: 810px;" allowfullscreen="true" __idm_frm__="90" __idm_id__="343232513"></iframe>
